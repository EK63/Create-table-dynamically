...
namespace DataRetrieve {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Surname, string Colour) {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public string Colour {
                get {
                    return ((string)(this[this.tableStudent.ColourColumn]));
                }
                set {
                    this[this.tableStudent.ColourColumn] = value;
                }
            }
        }
...
namespace DataRetrieve.Database1DataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([StudentId] = @Original_StudentId) AND ([Name" +
                "] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Colour] = @Origina" +
                "l_Colour))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Name], [Surname], [Colour]) VALUES (@Name, @Surname" +
                ", @Colour);\r\nSELECT StudentId, Name, Surname, Colour FROM Student WHERE (Student" +
                "Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Surname] = @Surname, [Colour] = @Colour WHERE (([StudentId] = @Original_StudentId) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Colour] = @Original_Colour));
SELECT StudentId, Name, Surname, Colour FROM Student WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataRetrieve.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, Name, Surname, Colour FROM dbo.Student";
        ...
        public virtual int Delete(int Original_StudentId, string Original_Name, string Original_Surname, string Original_Colour) {
        ...
        public virtual int Insert(string Name, string Surname, string Colour) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, string Colour, int Original_StudentId, string Original_Name, string Original_Surname, string Original_Colour, int StudentId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Colour, int Original_StudentId, string Original_Name, string Original_Surname, string Original_Colour) {
            return this.Update(Name, Surname, Colour, Original_StudentId, Original_Name, Original_Surname, Original_Colour, Original_StudentId);
        }
    }
